...
public class Curso
{
    ...
    private String capitalizarNombre(String nombre) {
        ...
        for(String palabra: str){
            if(palabra.equals("")){
                ...
                Character c = palabra.charAt(0);
                String primeraLetra = c.toString();
                String sinLetra = palabra.substring(1);
                String palabraNueva = primeraLetra.toUpperCase() + sinLetra;
                cap += palabraNueva + " ";
            }
        }
        return cap;
    ...
    public String getFechaFormateada() {
        String str = fecha.getDayOfMonth() + "  " + fecha.getMonth().toString().toLowerCase() + "  " + fecha.getYear();
        return str;
    }
