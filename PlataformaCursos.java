...
public class PlataformaCursos
{
    ...
    public String toString() {
        ...
        while(it.hasNext()){
            ...
            str += categoria + totalCursosEn(categoria);
            for(Curso curso: plataforma.get(categoria)){
                str += curso.toString();
            }
        }
        return str;
    ...
    public TreeSet<String> obtenerCategorias() {
        Set<String> categorias = plataforma.keySet();
        TreeSet<String> categoriasTree = new TreeSet<>();
        for(String categoria: categorias){
            categoriasTree.add(categoria);        
        }
